 ...
 *
 */
  $assign_to_config['site_name']  = 'cashadvisory';
  $assign_to_config['cp_url'] = 'http://cashadvisory.umbaugh.com/admin.php';
  $assign_to_config['site_url'] = 'http://cashadvisory.umbaugh.com';
