...
$config['cp_url'] = "http://www.umbaugh.com/admin.php";
...
$config['allow_extensions'] = "y";
 ...
 $config['cookie_prefix'] = ""; // Obviously, not the one I actually use...  

$config['cookie_httponly'] = "y";

$config['disable_csrf_protection'] = 'y'; //danny added

$config['secure_forms'] = "n"; //danny added
