...
<?php include( $_SERVER['DOCUMENT_ROOT'] . '/inc/header.php' ); ?>
		<div class="interior-content">
			...
			<img src="/images/title-seperator.png" width="657" height="4" id="solid-seperator" />
				...
				<p>Libraries have needs that are different from other units of government.  UMBAUGH financial consultants are experienced with library projects - from bond issues to property tax projections. We consider it very fulfilling to help libraries through all the financial aspects of completing a project!</p>
				...
				<div class="two-col-list">
        	        ...
        	        <ul class="left">
                        <li>Allen County Public Library, Fort Wayne, IN</li>
                        <li>Capital Area District Library, MI</li>
                        <li>Carmel-Clay Public Library, Carmel, IN</li>
                        <li>Culver-Union Township Public Library, Culver, IN</li>
	                </ul>
					<ul class="right">
						<li>Indianapolis-Marion County Public Library, Indianapolis, IN</li>
						<li>Johnson County Public Library, Franklin, IN</li>
						<li>Peabody Public Library, Columbia City, Lansing, IN</li>
					</ul>				
				</div>
				...
				<div id="wide-callout">
					...
					<p>Umbaugh Cash Advisory Services, LLC was developed as an independent business entity to help libraries create a structured investment program for their bond proceeds and operating funds.</p>
            ...
            <div id="sideColumn">
				...
				<div id="testimonial">
					<h2>Testimonial</h2>
    	                <p>The critical thing was that we had a really good, solid, well thought out financial plan.  The budget numbers we discussed were reliable. The financial plan provided a really great roadmap.</p>
