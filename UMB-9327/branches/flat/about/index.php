		...
		<div class="interior-content">
			...
			<img src="/images/team-photo.png" id="team-photo"/>
				<div id="professionals-list">
    	                ...
    	                <ul>
							<li><a href="#gmalone">Gerald G. Malone</a></li>
            	            <li><a href="#dfrederick">David C. Frederick</a></li>
                	        <li><a href="#jjulien">John D. Julien</a></li>
                    	    <li><a href="#jseever">John M Seever</a></li>
                        	<li><a href="#cirwin-knott">Colette J. Irwin-Knott</a></li>
	                        <li><a href="#tsamuelson">Todd A. Samuelson</a></li>
    	                    <li><a href="#cpletcher">Curt W. Pletcher</a></li>
        	                <li><a href="#smiller">Scott A. Miller</a></li>
            	        </ul>
                    </div>

					<div class="three-column">
        	            <ul>
							<li><a href="#lmatthes">Loren M. Matthes</a></li>
	                        <li><a href="#mgivler">Michael C. Givler</a></li>
                    	    <li><a href="#dhedden">Dan A. Hedden</a></li>
                	        <li><a href="#scarter">Stephen M. Carter</a></li>
            	            <li><a href="#dbaldessari">Doug Baldessari</a></li>
        	                <li><a href="#bcolton">Brian Colton</a></li>
    	                    <li><a href="#jsemler">Jason Semler</a></li>
	                    </ul>
					</div>
					<div class="three-column">
						<ul>
							<li><a href="#pgregory">Paige E. Gregory</a></li>
							<li><a href="#rclifford">Robert J. Clifford</a></li>
							<li><a href="#jmesser">Jeffrey A. Messer</a></li>
                    	</ul>
	                </div>
				</div><!-- end DIV #professionals-list -->
                       	    ...
                       	    <h3><strong>Gerald G. Malone</strong>, CPA</h3>  
								...
								<div class="two-col">
                                    <div class="contact-info">
                                        ...
                                        <ul>
                                            <li>(317) 465-1501</li>
                                            <li><a href="mailto:malone@umbaugh.com">malone@umbaugh.com</a></li>
                        	  ...
                        	  <h3><strong>David C. Frederick</strong>, CPA</h3>  
								...
								<div class="two-col">
                                    <div class="contact-info">
                                        ...
                                        <ul>
                                            <li>(317) 465-1502</li>
                                            <li><a href="mailto:frederick@umbaugh.com">frederick@umbaugh.com</a></li>
                                            <li>Download <a href="#">Vcard</a></li>
                                        </ul>
                                    </div>
								</div><!-- end DIV .two-col -->
		                        ...
		                        <h4>Experience</h4>
									<p>David C. Frederick works with cities, towns, counties and utilities, providing them with accounting and financial advisory services, including utility rate studies, cost-of-service analysis, municipal bond issues and expert testimony at regulatory, judicial and public hearings. He also oversees Umbaugh's arbitrage rebate services, escrow verifications and other attestation services.</p>
                        	  ...
                        	  <h3><strong>John D. Julien</strong>, CPA</h3>  
								...
								<div class="two-col">
                                    <div class="contact-info">
                                        ...
                                        <ul>
                                            <li>(574) 935-5178</li>
                                            <li><a href="mailto:julien@umbaugh.com">julien@umbaugh.com</a></li>
                                            <li>Download <a href="#">Vcard</a></li>
                                        </ul>
                                    </div>
								</div><!-- end DIV .two-col -->
						...
						<span class="professional-role">Partner, Indianapolis, IN</span>
								<div class="two-col">
                                    <div class="contact-info">
                                        ...
                                        <ul>
                                            <li>(317) 465-1504</li>
                                            <li><a href="mailto:irwinknott@umbaugh.com">irwinknott@umbaugh.com</a></li>
                                            <li>Download <a href="#">Vcard</a></li>
                                        </ul>
                                    </div>
								</div><!-- end DIV .two-col -->
		                        ...
		                        <h4>Experience</h4>
									<p>John Seever leads the Accounting Services Group and serves on the management committee of Umbaugh. Seever has been involved in many professional engagements, including financial studies for cities, towns and utilities. These studies often involve budgeting, financial reporting, annexation, consolidation and financial planning for municipalities and the determination of revenue requirements, cost-of-service studies and the financial planning associated with the issuance of debt and capital project planning for utilities.  </p>
						...
						<span class="professional-role">Partner, Plymouth, IN</span>
								<div class="two-col">
                                    <div class="contact-info">
                                        ...
                                        <ul>
                                            <li>(574) 935-5178</li>
                                            <li><a href="mailto:samuelson@umbaugh.com">samuelson@umbaugh.com</a></li>
                                            <li>Download <a href="#">Vcard</a></li>
                                        </ul>
                                    </div>
								</div><!-- end DIV .two-col -->
		                        <h4>Experience</h4>
									<p>Todd A. Samuelson works with cities, towns, counties, school corporations, libraries and utilities on comprehensive financial planning, bond issues and economic development.  He also assists numerous clients with budgeting, forecasting and strategic planning.</p>
						...
						<span class="professional-role">Partner, Plymouth, IN</span>
								<div class="two-col">
                                    <div class="contact-info">
                                        ...
                                        <ul>
                                            <li>(574) 935-5178</li>
                                            <li><a href="mailto:pletcher@umbaugh.com">pletcher@umbaugh.com</a></li>
                                            <li>Download <a href="#">Vcard</a></li>
                                        </ul>
                                    </div>
								</div><!-- end DIV .two-col -->
						...
						<span class="professional-role">Partner, Indianapolis, IN</span>
								<div class="two-col">
                                    <div class="contact-info">
                                        ...
                                        <ul>
                                            <li>(317) 465-1506</li>
                                            <li><a href="mailto:miller@umbaugh.com">miller@umbaugh.com</a></li>
                                            <li>Download <a href="#">Vcard</a></li>
                                        </ul>
                                    </div>
								</div><!-- end DIV .two-col -->
		                        ...
		                        <h4>Experience</h4>
                                    <p>Scott A. Miller works primarily with utility clients.  He has performed financial studies for municipally-owned water, electric, gas and sewage utilities, not-for-profit and investor owned water and sewer corporations, regional water and sewer districts and conservancy districts. These studies often involve determining utility revenue and rate requirements, cost-of-service studies and the financial planning associated with the acquisition of capital.  Miller also oversees Umbaugh's regulatory services. </p>
						...
						<span class="professional-role">Principal, Indianapolis, IN</span>
								<div class="two-col">
                                    <div class="contact-info">
                                        ...
                                        <ul>
                                            <li>(317) 465-1505</li>
                                            <li><a href="mailto:matthes@umbaugh.com">matthes@umbaugh.com</a></li>
                                            <li>Download <a href="#">Vcard</a></li>
                                        </ul>
                                    </div>
								</div><!-- end DIV .two-col -->
		                        ...
		                        <h4>Experience</h4>
                                    <p>Loren M. Matthes assists city, town and county officials in planning and financing government buildings, infrastructure projects, downtown redevelopment projects, parking garages, aquatic centers and educational facilities. Matthes also works on structuring incentive packages for industrial/commercial prospects and negotiating economic development terms with companies, developers and underwriters. These projects often use a combination of incentives and revenue sources, such as tax abatement, tax increment, local option income taxes and State grant funds.</p>
                                    <p>Since Matthes' involvement with the first tax increment financing (TIF) revenue bond issue sold in Indiana in 1985, she has worked on hundreds of economic development and TIF projects throughout the state, developing a statewide reputation for her expertise in this area. She is frequently contacted by local officials and administrators, county auditors, and State agencies to provide advice and guidance.</p>
						...
						<span class="professional-role">Principal, Lansing, MI</span>
								<div class="two-col">
                                    <div class="contact-info">
                                        ...
                                        <ul>
                                            <li>(517) 321-0110</li>
                                            <li><a href="mailto:givler@umbaugh.com">givler@umbaugh.com</a></li>
                                            <li>Download <a href="#">Vcard</a></li>
                                        </ul>
                                    </div>
								</div><!-- end DIV .two-col -->
						...
						<span class="professional-role">Principal, Indianapolis, IN</span>
								<div class="two-col">
                                    <div class="contact-info">
                                        ...
                                        <ul>
                                            <li>(317) 465-1503</li>
                                            <li><a href="mailto:hedden@umbaugh.com">hedden@umbaugh.com</a></li>
                                            <li>Download <a href="#">Vcard</a></li>
                                        </ul>
                                    </div>
								</div><!-- end DIV .two-col -->
		                        ...
		                        <h4>Experience</h4>
                                    <p>Daniel A. Hedden's practice is focused on management advisory services, ranging from training to budget services, budget modeling, financial management reports and advanced services involving financial accounting and reporting. In addition, he assists governmental units with process management and increasing their technology utilization to provide better and more useful information to a wider range of users. Hedden has been involved with financial studies for municipally-owned utilities, not-for-profit corporations, regional water and sewer districts and conservancy districts.</p>
						...
						<span class="professional-role">Principal, Plymouth, IN</span>
								<div class="two-col">
                                    <div class="contact-info">
                                        ...
                                        <ul>
                                            <li>(574) 935-5178</li>
                                            <li><a href="mailto:carter@umbaugh.com">carter@umbaugh.com</a></li>
                                            <li>Download <a href="#">Vcard</a></li>
                                        </ul>
                                    </div>
								</div><!-- end DIV .two-col -->
						...
						<span class="professional-role">Principal, Indianapolis, IN</span>
								<div class="two-col">
                                    <div class="contact-info">
                                        ...
                                        <ul>
                                            <li>(317) 465-1508</li>
                                            <li><a href="mailto:baldessari@umbaugh.com">baldessari@umbaugh.com</a></li>
                                            <li>Download <a href="#">Vcard</a></li>
                                        </ul>
                                    </div>
								</div><!-- end DIV .two-col -->
						...
						<span class="professional-role">Principal, Indianapolis, IN</span>
								<div class="two-col">
                                    <div class="contact-info">
                                        ...
                                        <ul>
                                            <li>(317) 465-1516</li>
                                            <li><a href="mailto:colton@umbaugh.com">colton@umbaugh.com</a></li>
                                            <li>Download <a href="#">Vcard</a></li>
                                        </ul>
                                    </div>
								</div><!-- end DIV .two-col -->
						...
						<span class="professional-role">Principal (effective 2011), Indianapolis, IN</span>
								<div class="two-col">
                                    <div class="contact-info">
                                        ...
                                        <ul>
                                            <li>(317) 465-1540</li>
                                            <li><a href="mailto:semler@umbaugh.com">semler@umbaugh.com</a></li>
                                            <li>Download <a href="#">Vcard</a></li>
                                        </ul>
                                    </div>
								</div><!-- end DIV .two-col -->
		                        <h4>Experience</h4>
									<p>Jason G. Semler works on economic development, financing and utility projects. His economic development work involves developing diverse revenue sources, such as tax increment financing (TIF) and local option income taxes, examining taxing units' assessed values and their respective abatements, and the financial planning associated with the issuance of both tax-exempt and taxable bonds.</p>
			...
			<img src="../images/rclifford.png" width="100" height="130" />
				<div class="bio-info">
						...
						<span class="professional-role">Principal (effective 2011), Indianapolis, IN</span>
		                        ...
		                        <h4>Experience</h4>
									<p>Robert J. (Bob) Clifford works on utility financing matters, budgeting, feasibility studies and other financial studies for cities, towns and other local units of government, including preparing monthly and annual financial statements for municipally owned utilities.</p>
			...
			<img src="../images/jmesser.png" width="100" height="130" />
						...
						<span class="professional-role">Director of Umbaugh Cash Advisory Services, LLC, Indianapolis, IN</span>
								<div class="two-col">
                                    <div class="contact-info">
                                        ...
                                        <ul>
                                            <li>(317) 465-1531</li>
                                            <li><a href="mailto:messer@umbaugh.com">messer@umbaugh.com</a></li>
                                            <li>Download <a href="#">Vcard</a></li>
                                        </ul>
                                    </div>
								</div><!-- end DIV .two-col -->
		                        <h4>Experience</h4>
                                    <p>Jeffrey A. Messer serves as an independent investment advisor in Michigan, Indiana and Illinois.  He has 22 years of banking experience in Michigan, Indiana and throughout the Midwest with an emphasis on public funds banking and investments.</p>
                                    <p>At Umbaugh Cash Advisory Services he provides investment and banking services to municipalities throughout Indiana and Michigan, including helping municipalities invest their municipal bond proceeds and operating funds.  Messer has assisted municipalities in structuring more than $1 billion of municipal bond proceeds.  He also led a team of bankers in creating two new successful municipal investment products. </p>
                                    <p>Messer joined Umbaugh in 2005.  His group provides independent advice on investments in excess of $450 million in assets for school districts and local units of government throughout Indiana and Michigan; and is responsible for bank analysis and RFPs for banking services for many Umbaugh clients. </p>
                ...
                </div><!-- end DIV #professionals-table -->
