...
<?php include( $_SERVER['DOCUMENT_ROOT'] . '/inc/header.php' ); ?>
	...
	<div class="home-content">
		...
		<div class="banner-tab-labels">
			<ul>
				<li class="first active"><a href="#tab1" class="banner-tab-label">Umbaugh</a></li>
				<li><a href="#tab2" class="banner-tab-label">Local Government</a></li>
				<li><a href="#tab3" class="banner-tab-label">Utilities</a></li>
				<li><a href="#tab4" class="banner-tab-label">Economic Development</a></li>
